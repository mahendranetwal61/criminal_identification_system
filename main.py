...
def getPage1():
    ...
    tk.Button(scroll_frame, text="Register", command=lambda: register(entries, required, menu_var), font="Arial 15 bold",
           bg="#2196f3", fg="white", pady=5, padx=30, bd=0, highlightthickness=0, activebackground="#091428",
           activeforeground="white").pack(pady=25)
    tk.Button(scroll_frame, text="SHOW DATA", command=lambda: fetch_data(),
              font="Arial 15 bold",
              bg="#2196f3", fg="white", pady=5, padx=30, bd=0, highlightthickness=0, activebackground="#091428",
              activeforeground="white").pack(pady=25)
...
######################################## Home Page ####################################
tk.Label(pages[0], text="Criminal Identification System", fg="white", bg="red",
...
for btn in btn_frame.winfo_children():
    btn.configure(font="Arial 20", width=17, bg="#2196f3", fg="white",
        pady=15, bd=0, highlightthickness=0, activebackground="green", activeforeground="white")
    btn.pack(pady=15)
